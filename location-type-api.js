(function(){
  ...
  style.textContent='.location-type-filter{display:flex;align-items:center;gap:10px;margin:0 0 14px}.location-type-filter input,.location-type-filter select{height:38px;padding:0 11px;border:1px solid #dfe3e6;border-radius:8px;outline:0;background:#fff;font-size:12px}.location-type-filter input{width:min(250px,40vw)}.location-type-filter button{height:38px;padding:0 15px;border:0;border-radius:8px;color:var(--blue-strong);background:var(--blue-pale);font-size:12px;font-weight:650;cursor:pointer}.location-type-empty{text-align:center;color:var(--muted)}.location-type-actions{display:flex;gap:7px}.location-type-row-btn{height:27px;padding:0 10px;border:1px solid #cde2f3;border-radius:15px;color:var(--blue-strong);background:#f1f8fd;font-size:11px;font-weight:650;cursor:pointer}.location-type-row-btn.delete{color:var(--red);border-color:#f3d7d5;background:#fff5f4}.location-type-row-btn:disabled{cursor:not-allowed;opacity:.55}.form-field textarea{min-height:76px;padding:10px 11px;resize:vertical;border:1px solid #dfe3e6;border-radius:8px;outline:0;background:#fff;font:inherit;font-size:12px}@media(max-width:760px){.location-type-filter{align-items:stretch;flex-direction:column}.location-type-filter input,.location-type-filter select,.location-type-filter button{width:100%}}';
