...
.filter-bar{display:flex;align-items:center;gap:10px;margin:15px 0}.filter-bar .filter{margin:0}.filter-actions{display:flex;gap:8px}.filter-reset,.filter-query{height:40px;padding:0 18px;border:1px solid #dfe4e8;border-radius:8px;background:#fff;font-weight:650;cursor:pointer}.filter-query{color:#fff;border-color:var(--blue);background:var(--blue)}
