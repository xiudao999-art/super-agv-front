  ...
  <div :class="['storage-resource-page', `${props.resourceKey}-page`]">
    ...
    <div class="page-canvas"><section class="page-panel">
      ...
      <div class="content agv-list-page">
        ...
        <div v-if="props.resourceKey !== 'locations'" :class="[props.resourceKey === 'storageTypes' ? 'location-type-filter' : 'carrier-filter', 'agv-filter-bar']" data-agv-list-filters>
