...
const formTitle = computed(() => {
  ...
  if (props.resourceKey === 'storageTypes') return '编辑类型配置'
  ...
  <div :class="['storage-resource-page', `${props.resourceKey}-page`]">
    ...
    <div class="page-canvas"><section class="page-panel">
      ...
      <div class="content agv-list-page">
        ...
        <div v-if="['carriers', 'carrierTypes'].includes(props.resourceKey)" class="carrier-filter agv-filter-bar" data-agv-list-filters>
